...
<details><summary>Abstract</summary><p>Countries with greater wealth inequality experience deeper recessions during sudden stops, which are episodes of abrupt capital outflows. Household-level data show that more unequal countries have a larger share of indebted households and that average debt and asset values fall more for indebted households as new borrowing and asset purchases decline during sudden stops. I develop a tractable model with heterogeneous households subject to borrowing constraints to account for all three facts. Greater inequality increases the fraction of constrained households, thereby amplifying deleveraging and the declines in asset prices and aggregate consumption following an adverse aggregate shock. In the quantitative model, a 0.01 increase in the wealth Gini adds 0.07 and 0.11 percentage points to the declines in GDP and consumption per percentage point of capital outflow during a sudden stop, in line with the data. I show that optimal taxes on wealth and external debt under commitment raise social welfare by 11.24% in consumption-equivalent terms relative to the equilibrium without taxes.</p></details>
