...
**Sudden Stops and Wealth Inequality: The Severity of Downturns** | [Link](https://yyun23.github.io/assets/pdf/papers/Yun_JMP.pdf) | [SSRN](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=7346466)<br>
<details><summary>Abstract</summary><p>Wealth inequality deepens the contractions in GDP, domestic absorption, and asset prices that accompany sudden stops, which are recessions marked by excessive capital outflows. Cross-country data show that outflows of the same size generate larger contractions during sudden stops in countries with greater wealth inequality. European household survey data show that household leverage rises with wealth inequality and that only the leveraged households cut debt and assets together. I build a tractable model in which heterogeneous households face borrowing limits tied to the market value of their assets. The model rationalizes the empirical facts as greater inequality places more households at the borrowing limit and deepens the declines in asset prices and aggregate consumption following an adverse aggregate shock. A quantitative model that extends the tractable model to infinite horizon demonstrates that a 0.01 increase in the wealth Gini produces additional GDP and consumption declines of 0.07 and 0.11 percentage points per percentage point of capital outflow during a sudden stop in the model, compared with 0.09 and 0.07 percentage points in the data. Using the quantitative model, I show that an optimal taxation on wealth and external debt with commitment improves social welfare by 17.38% relative to the equilibrium without taxes.</p></details>
